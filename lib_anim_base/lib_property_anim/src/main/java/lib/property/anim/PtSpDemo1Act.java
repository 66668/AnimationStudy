...
public class PtSpDemo1Act extends AppCompatActivity implements View.OnClickListener {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                if ((Float) animation.getAnimatedValue() == 250f) {//pt_objanimator_trans_r.xml的最终位置值
                    Toast.makeText(PtSpDemo1Act.this, "这是实时监听最后结果的打印", Toast.LENGTH_SHORT).show();
                    ObjectAnimator animator = (ObjectAnimator) AnimatorInflater.loadAnimator(PtSpDemo1Act.this, R.animator.pt_objanimator_trans_l);
                    animator.setTarget(img);//不设置该方法，动画不执行
                    animator.start();
                }
            }
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if ((Float) animation.getAnimatedValue() == 2f) {//pt_objanimator_trans_r.xml的最终位置值
                        Toast.makeText(PtSpDemo1Act.this, "放大方式1", Toast.LENGTH_SHORT).show();
                        ObjectAnimator animator = (ObjectAnimator) AnimatorInflater.loadAnimator(PtSpDemo1Act.this, R.animator.pt_objanimator_scale_big_y);
                        animator.setTarget(img);//不设置该方法，动画不执行
                        animator.start();
                    }
                }
    ...
    private void ValueAnimator_xml_trans_1() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                if ((Float) animation.getAnimatedValue() == -250f) {//pt_objanimator_trans_r.xml的最终位置值
                    Toast.makeText(PtSpDemo1Act.this, "这是实时监听最后结果的打印", Toast.LENGTH_SHORT).show();
                    ObjectAnimator animator = (ObjectAnimator) AnimatorInflater.loadAnimator(PtSpDemo1Act.this, R.animator.pt_objanimator_trans_down);
                    animator.setTarget(img);//不设置该方法，动画不执行
                    animator.start();
                }
            }
    ...
    private void ValueAnimator_xml_rotate_1() {
        ObjectAnimator animator = (ObjectAnimator) AnimatorInflater.loadAnimator(PtSpDemo1Act.this, R.animator.pt_objanimator_rotation_l);
        animator.setTarget(img);//不设置该方法，动画不执行
        animator.start();
    }
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if ((Float) animation.getAnimatedValue() == 1f) {//pt_objanimator_trans_r.xml的最终位置值
                        Toast.makeText(PtSpDemo1Act.this, "缩小方式1", Toast.LENGTH_SHORT).show();
                        ObjectAnimator animator = (ObjectAnimator) AnimatorInflater.loadAnimator(PtSpDemo1Act.this, R.animator.pt_objanimator_scale_small_y);
                        animator.setTarget(img);//不设置该方法，动画不执行
                        animator.start();
                    }
                }
        ...
        if (type == 0) {
            ...
            animatorX.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if ((Float) animation.getAnimatedValue() == 1f) {//如果执行完，就执行下边动画
                        Toast.makeText(PtSpDemo1Act.this, "方式1：这是x方向放大", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else if (type == 1) {
            ...
            animatorY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    //animation.getAnimatedValue()的值是动态变化的，所以只监听结果
                    if ((Float) animation.getAnimatedValue() == 1f) {//如果执行完，就执行下边动画
                        Toast.makeText(PtSpDemo1Act.this, "方式2：这是y方向放大", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
...
//            ObjectAnimator animatorY = ObjectAnimator.ofFloat(img, "scaleY", 1f, 2f,3f,4f);
            ...
            set.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    Toast.makeText(PtSpDemo1Act.this, "方式3：这是组合动画，xy方向同时放大", Toast.LENGTH_SHORT).show();
                }
    ...
    private void ValueAnimator_code_all_2() {
        ...
        set.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (type == 0) {
                    Toast.makeText(PtSpDemo1Act.this, "方式1：综合样式", Toast.LENGTH_SHORT).show();
                } else if (type == 1) {
                    Toast.makeText(PtSpDemo1Act.this, "方式2：综合样式", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PtSpDemo1Act.this, "方式3：综合样式", Toast.LENGTH_SHORT).show();
                }
...
//      开始动画
        ...
        if (type == 0) {
            ...
            animatorX.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    //animation.getAnimatedValue()的值是动态变化的，所以只监听结果
                    if ((Float) animation.getAnimatedValue() == 1f) {//如果执行完，就执行下边动画
                        Toast.makeText(PtSpDemo1Act.this, "方式1：这是x方向缩小", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else if (type == 1) {
            ...
            animatorY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    //animation.getAnimatedValue()的值是动态变化的，所以只监听结果
                    if ((Float) animation.getAnimatedValue() == 1f) {//如果执行完，就执行下边动画
                        Toast.makeText(PtSpDemo1Act.this, "方式2：这是y方向缩小", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
            ...
            animatorY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    //animation.getAnimatedValue()的值是动态变化的，所以只监听结果
                    if ((Float) animation.getAnimatedValue() == 1f) {//如果执行完，就执行下边动画
                        Toast.makeText(PtSpDemo1Act.this, "方式3：这是xy方向同时缩小", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
        ...
        if (type == 0) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    //animation.getAnimatedValue()的值是动态变化的，所以只监听结果
                    if ((Float) animation.getAnimatedValue() == 250f) {
                        Toast.makeText(PtSpDemo1Act.this, "方式1：单独播放PropertyValuesHolder动画", Toast.LENGTH_SHORT).show();
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                @Override
                public void onAnimationEnd(Animator animation) {
                    Toast.makeText(PtSpDemo1Act.this, "方式2：PropertyValuesHolder动画并行播放", Toast.LENGTH_SHORT).show();
    ...
    private void ValueAnimator_code_all_4() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                Toast.makeText(PtSpDemo1Act.this, "PropertyValuesHolder+ObjectAnimator综合样式", Toast.LENGTH_SHORT).show();
            }
