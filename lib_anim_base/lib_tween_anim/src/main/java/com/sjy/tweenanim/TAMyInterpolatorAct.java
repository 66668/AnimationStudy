...
/**
 * Tween Animation 插值器三详解之三：自定义
 * 本例是code方式+xml方式
 */
public class TAMyInterpolatorAct extends AppCompatActivity {

    @BindView(R2.id.img)
    ImageView img;
    @BindView(R2.id.btn_my_accelerate)
    Button btn_my_accelerate;
    @BindView(R2.id.btn_my_anticipate)
    Button btn_my_anticipate;
    @BindView(R2.id.btn_my_anticipate_overshoot)
    Button btn_my_anticipate_overshoot;
    @BindView(R2.id.btn_my_cycle)
    Button btn_my_cycle;
    @BindView(R2.id.btn_my_overshoot_interpolator)
    Button btn_my_overshoot_interpolator;
    ...
    @OnClick({
            R2.id.btn_my_accelerate, R2.id.btn_my_anticipate, R2.id.btn_my_anticipate_overshoot,
            R2.id.btn_my_cycle, R2.id.btn_my_overshoot_interpolator,
    ...
    public void OnClicks(View view) {
        ...
        } else if (view == btn_my_accelerate) {
            xml_accelerate();
        } else if (view == btn_my_anticipate) {
            xml_anticipate();
        } else if (view == btn_my_anticipate_overshoot) {
            xml_anticipate_overshoot();
        } else if (view == btn_my_cycle) {
            xml_cycle();
        } else if (view == btn_my_overshoot_interpolator) {
            xml_overshoot();
        }
    }
//------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------
     ...
     * accelerate
     */
    private void xml_accelerate() {
        Animation trans = AnimationUtils.loadAnimation(this, R.anim.my_accelerate);
        //清除之前动画没执行完的影响
     ...
     * anticipate
     */
    private void xml_anticipate() {
        Animation trans = AnimationUtils.loadAnimation(this, R.anim.my_antipite);
        //清除之前动画没执行完的影响
        Animation oldAnimation = img.getAnimation();
        if (oldAnimation != null) {
            if (oldAnimation.hasStarted() || (!oldAnimation.hasEnded())) {
     ...
     */
    private void xml_anticipate_overshoot() {
        Animation trans = AnimationUtils.loadAnimation(this, R.anim.my_antipite_overshoot);
        //清除之前动画没执行完的影响
        Animation oldAnimation = img.getAnimation();
        if (oldAnimation != null) {
            if (oldAnimation.hasStarted() || (!oldAnimation.hasEnded())) {
     ...
     * cycle
     */
    private void xml_cycle() {
        Animation trans = AnimationUtils.loadAnimation(this, R.anim.my_cycle);
        //清除之前动画没执行完的影响
        Animation oldAnimation = img.getAnimation();
        if (oldAnimation != null) {
            if (oldAnimation.hasStarted() || (!oldAnimation.hasEnded())) {
     ...
     * overshoot
     */
    private void xml_overshoot() {
        Animation trans = AnimationUtils.loadAnimation(this, R.anim.my_overshoot);
        //清除之前动画没执行完的影响
        Animation oldAnimation = img.getAnimation();
        if (oldAnimation != null) {
            if (oldAnimation.hasStarted() || (!oldAnimation.hasEnded())) {
    ...
    private void AccelerateDecelerateInterpolator_translate() {
        TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 200,
    ...
    private void AccelerateInterpolator_translate() {
        TranslateAnimation animation = new TranslateAnimation(Animation.ABSOLUTE, 0, Animation.ABSOLUTE, 200,
    ...
    private void AccelerateInterpolator_rotate() {
        ...
        //自定义AccelerateInterpolator
        right.setInterpolator(new AccelerateInterpolator(3));
    ...
    private void AccelerateInterpolator_scale() {
        ...
        //自定义AccelerateInterpolator
        small.setInterpolator(new AccelerateInterpolator(3));
    ...
    private void AccelerateInterpolator_alpha() {
        ...
        //自定义AccelerateInterpolator
        alpha.setInterpolator(new AccelerateInterpolator(3));
    ...
    private void AnticipateInterpolator_translate() {
        TranslateAnimation animation = new TranslateAnimation(Animation.ABSOLUTE, 0, Animation.ABSOLUTE, 100,
                Animation.ABSOLUTE, 0, Animation.ABSOLUTE, 0);
        animation.setDuration(1000);
        animation.setFillAfter(true);
        animation.setFillBefore(true);
    ...
    private void AnticipateInterpolator_rotate() {
        ...
        //自定义AnticipateInterpolator
        right.setInterpolator(new AnticipateInterpolator(3));
    ...
    private void AnticipateInterpolator_scale() {
        ...
        //自定义AnticipateInterpolator
        small.setInterpolator(new AnticipateInterpolator(3));
    ...
    private void AnticipateInterpolator_alpha() {
        ...
        //自定义AnticipateInterpolator
        alpha.setInterpolator(new AnticipateInterpolator(3));
    ...
    private void AnticipateOvershootInterpolator_rotate() {
        ...
        //自定义AnticipateOvershootInterpolator
        right.setInterpolator(new AnticipateOvershootInterpolator(4));
    ...
    private void AnticipateOvershootInterpolator_scale() {
        ...
        //自定义AnticipateOvershootInterpolator
        small.setInterpolator(new AnticipateOvershootInterpolator(4));
    ...
    private void AnticipateOvershootInterpolator_alpha() {
        ...
        //自定义AnticipateOvershootInterpolator
        alpha.setInterpolator(new AnticipateOvershootInterpolator(4));
    ...
    private void AnticipateOvershootInterpolator_all() {
        ...
        //自定义AnticipateOvershootInterpolator
        set.setInterpolator(new AnticipateOvershootInterpolator(4));
        //
        img.startAnimation(set);
    }
    ...
    private void CycleInterpolator_rotate() {
        ...
        //自定义CycleInterpolator
        right.setInterpolator(new CycleInterpolator(3));
    ...
    private void CycleInterpolator_scale() {
        ...
        //自定义CycleInterpolator
        small.setInterpolator(new CycleInterpolator(3));
